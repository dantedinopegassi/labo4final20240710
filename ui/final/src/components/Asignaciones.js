...
const Asignaciones = () => {
  ...
  const addAsignacion = async () => {
    await api.post('/asignaciones', { aula_id: aulaId, materia_id: materiaId, dia_semana: dia, hora_inicio: horaInicio, hora_fin: horaFin });
    fetchAsignaciones();
  };
    ...
    <div>
      ...
      <Form>
        <Form.Group controlId="aula">
          ...
          <Form.Control as="select" value={aulaId} onChange={(e) => setAulaId(e.target.value)}>
